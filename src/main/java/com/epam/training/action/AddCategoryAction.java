...
public class AddCategoryAction implements Action {
    private static Logger logger = Logger.getLogger(AddCategoryAction.class);
        ...
        switch (request.getMethod()) {
            case METHOD_POST:
                ...
                for (int i = 1; i <= locales.size(); i++) {
                    ...
                    category.setCategoryName((String) request.getParameter(CATEGORY_NAME + i));
                ...
                if (correctness == 0) {
                    ...
                    correctness = 0;
                    for (Category category : categories) {
                        request.setAttribute(INPUT_CATEGORY_NAME, category.getCategoryName());
                    }
                }
        }
